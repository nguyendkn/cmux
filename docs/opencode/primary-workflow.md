...
Choose agent models based on task complexity (see agent files for defaults):

| Purpose | Claude Model | External Model |
| --- | --- | --- |
| Planning, architecture | `sonnet` | `gemini-claude-sonnet-4-5-thinking` |
| Implementation, code gen | `sonnet` | `gemini-3-pro-preview` |
| Code review | `sonnet` | `gemini-claude-sonnet-4-5-thinking` |
| Testing | `sonnet` | `gemini-claude-sonnet-4-5` |
| Deep debugging, security | `opus` | `claude-opus-4-6-thinking` |
| Research, scouting, docs | `haiku` | `gemini-2.5-flash` |
| Git ops | `haiku` | `gemini-2.5-flash-lite` |
